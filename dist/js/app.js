  ...
  methods: {
    ...
    setIndex: function setIndex(index) {
      ...
      this.$nextTick(function () {
        //延遲執行
        _this.$refs['index_' + index] && _this.$refs['index_' + index][0].focus();
      }); //}
    },
    ...
    _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "form-group col-sm-4" }, [
        ...
        _c(
          ...
          [
            _c("option", { attrs: { value: "" } }, [_vm._v("Select Sex")]),
            _vm._v(" "),
            _c("option", { attrs: { value: "M" } }, [_vm._v("Male")]),
            _vm._v(" "),
            _c("option", { attrs: { value: "F" } }, [_vm._v("Female")]),
            _vm._v(" "),
            _c("option", { attrs: { value: "X" } }, [_vm._v("Unknown")])
          ]
        )
      ]),
      _vm._v(" "),
            ...
            return _c("tr", { key: index }, [
              ...
              _c("td", [
                ...
                _c(
                  ...
                  [_c("i", { staticClass: "far fa-trash-alt" }), _vm._v(" Del")]
                )
              ])
            ])
          }),
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); //表頭型態指定
...
__webpack_require__(/*! D:\Ray\laravel-mix\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! D:\Ray\laravel-mix\src\app.scss */"./src/app.scss");
